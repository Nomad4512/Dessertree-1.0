		...
		<div class="col-lg-5">
			<div class="jumbotron" style="padding-top: 20px;">
				<form method="post" action="loginAction.jsp">
					<h3 style="text-align: left;">로그인을 해주세요.</h3>
					<h5 style="text-align: left;">아직 아이디가 없다면 회원가입을 해주세요.</h5>
					...
					<div class="login-form-link" style="text-align: center;">
						<br>
						<a href="join.jsp" class="login-form-link-join">회원가입</a>
						<span class="txt-bar">|</span>
						<a href="findIDPW.jsp">아이디/비밀번호 찾기</a>
						<span class="txt-bar">|</span>
						<a href="reUseID" class="login-form-link-join">휴면 계정 재이용</a>
					</div>
				</form>
			</div>
		</div>
